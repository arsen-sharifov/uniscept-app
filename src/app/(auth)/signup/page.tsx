  ...
  return (
    <div className="w-full max-w-sm">
      <div className="mb-8 text-center">
        <h1 className="text-2xl font-bold text-black">{step === 1 ? planStep.heading : signUpT.heading}</h1>
        <p className="mt-1 text-sm text-black/50">{step === 1 ? planStep.subtitle : signUpT.subtitle}</p>
      </div>
