...
export const EXPORT_NODE_ID_ATTRIBUTE = 'data-node-id';
export const EXPORT_EDGE_ID_ATTRIBUTE = 'data-edge-id';
...
export const CSS_URL_PATTERN = /url\(([^)]*)\)/g;
export const UNICODE_RANGE_PATTERN = /^U\+([\dA-F?]+)(?:-([\dA-F]+))?$/i;
