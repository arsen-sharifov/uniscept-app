  ...
  return (
    ...
    >
      <div className="relative flex -translate-y-1/2 items-center gap-2 rounded-lg bg-neutral-900 py-1.5 pr-1.5 pl-2.5 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.55)]">
        <span className="text-[12px] font-medium tracking-tight text-white/95">{tool?.label ?? ''}</span>
        ...
        <span aria-hidden className="absolute top-1/2 -right-1 h-2 w-2 -translate-y-1/2 rotate-45 bg-neutral-900" />
      </div>
    </div>
  );
};
