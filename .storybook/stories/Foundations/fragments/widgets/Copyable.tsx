...
export const Copyable = ({ value, display, className }: ICopyableProps) => {
  ...
  return (
    <button
      ...
      className={clsx(
        'group inline-flex items-center gap-1.5 rounded-md bg-[color:var(--surface-overlay)] px-2 py-0.5 font-mono-ui text-[10.5px] tracking-[0.04em] text-[color:var(--text-muted)] transition-colors hover:bg-[color:var(--surface-elevated)] hover:text-[color:var(--text-strong)]',
